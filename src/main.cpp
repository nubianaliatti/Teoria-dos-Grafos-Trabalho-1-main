...
Grafo *leituraRR(ifstream &input_file) {
    ...
    Grafo *graph = new Grafo(order, cluster, clusterType, clustersLimits);
...
Grafo *leituraHandover(ifstream &input_file) {
...
void selecionar(ofstream &output_file,int selecao, Grafo *graph) {
